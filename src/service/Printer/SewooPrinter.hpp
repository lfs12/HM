...
public:
    ...
    static std::map<std::string, std::string> StatusSewoo1;
    static std::map<std::string, std::string> StatusSewoo2;
    static std::map<std::string, std::string> StatusSewoo3;
};

class SewooPrinter : public PrinterInterface
{
private:
    ...
    std::string analizarFactura(std::string,int, std::string, std::string);
    ...
    StatusSewoo leerStatus();
    void configurarFuente();

public:
    SewooPrinter(std::string, std::string="8N1");
