...
public:
 // AppService servAppService;
    ...
    static std::map<std::string, std::string> StatusVmax1;
    static std::map<std::string, std::string> StatusVmax2;
    static std::map<std::string, std::string> StatusVmax3;
};

class VmaxPrinter : public PrinterInterface
{
private:
